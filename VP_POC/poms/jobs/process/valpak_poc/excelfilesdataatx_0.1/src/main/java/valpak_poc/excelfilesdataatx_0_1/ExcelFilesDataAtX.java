...
package valpak_poc.excelfilesdataatx_0_1;
...
/**
 * Job: ExcelFilesDataAtX Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class ExcelFilesDataAtX implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "ExcelFilesDataAtX.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(ExcelFilesDataAtX.class);
	...
	private final String jobName = "ExcelFilesDataAtX";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					ExcelFilesDataAtX.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ExcelFilesDataAtX.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_VALPAK_POC_ExcelFilesDataAtX = new byte[0];
		static byte[] commonByteArray_VALPAK_POC_ExcelFilesDataAtX = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_VALPAK_POC_ExcelFilesDataAtX.length) {
					if (length < 1024 && commonByteArray_VALPAK_POC_ExcelFilesDataAtX.length == 0) {
						commonByteArray_VALPAK_POC_ExcelFilesDataAtX = new byte[1024];
					} else {
						commonByteArray_VALPAK_POC_ExcelFilesDataAtX = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_VALPAK_POC_ExcelFilesDataAtX, 0, length);
				strReturn = new String(commonByteArray_VALPAK_POC_ExcelFilesDataAtX, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_VALPAK_POC_ExcelFilesDataAtX, 0, length);
				strReturn = new String(commonByteArray_VALPAK_POC_ExcelFilesDataAtX, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_VALPAK_POC_ExcelFilesDataAtX) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileOutputExcel_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputExcel_1.append("FILENAME" + " = "
									+ "\"C:/Users/valpakuser/Desktop/Outputs/JDWilliams Q1 2024 To Load Demo - beginning at row 5_output.xlsx\"");
							log4jParamters_tFileOutputExcel_1.append(" | ");
				...
				String fileName_tFileOutputExcel_1 = "C:/Users/valpakuser/Desktop/Outputs/JDWilliams Q1 2024 To Load Demo - beginning at row 5_output.xlsx";
					...
					class BytesLimit65535_tFileInputExcel_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputExcel_1.append("FILENAME" + " = "
									+ "\"C:/Users/valpakuser/Desktop/ValPak PoC Data/JDWilliams Q1 2024 To Load Demo - beginning at row 5.xlsx\"");
							log4jParamters_tFileInputExcel_1.append(" | ");
							log4jParamters_tFileInputExcel_1.append("PASSWORD" + " = "
									+ String.valueOf(
											"enc:routine.encryption.key.v1:nJ61amELiyfYlVb8czVcloxgAttDqqW8vwRb6A==")
											.substring(0, 4)
									+ "...");
							log4jParamters_tFileInputExcel_1.append(" | ");
							...
							log4jParamters_tFileInputExcel_1.append(" | ");
							log4jParamters_tFileInputExcel_1.append("FIRST_COLUMN" + " = " + "2");
							log4jParamters_tFileInputExcel_1.append(" | ");
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:HZ24Kw74M0YxFfNAsEM7Bl+BLY9+2ZqMYysKMA==");
				String password_tFileInputExcel_1 = decryptedPassword_tFileInputExcel_1;
				if (password_tFileInputExcel_1.isEmpty()) {
					password_tFileInputExcel_1 = null;
				}
				Object source_tFileInputExcel_1 = "C:/Users/valpakuser/Desktop/ValPak PoC Data/JDWilliams Q1 2024 To Load Demo - beginning at row 5.xlsx";
...
// Start of branch "row1"
	...
	public static void main(String[] args) {
		final ExcelFilesDataAtX ExcelFilesDataAtXClass = new ExcelFilesDataAtX();

		int exitCode = ExcelFilesDataAtXClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'ExcelFilesDataAtX' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'ExcelFilesDataAtX' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_zhzCgK2NEe-R9K8WvBgLMQ");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-12-09T16:52:19.470961800Z");
		...
		try {
			...
			java.io.InputStream inContext = ExcelFilesDataAtX.class.getClassLoader()
					.getResourceAsStream("valpak_poc/excelfilesdataatx_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ExcelFilesDataAtX.class.getClassLoader()
		...
		log.info("TalendJob: 'ExcelFilesDataAtX' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : ExcelFilesDataAtX");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'ExcelFilesDataAtX' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 110592 characters generated by Talend Cloud Data Fabric on the December 9,
 * 2024 at 4:52:19 PM UTC
 ************************************************************************************************/