...
package valpak_poc.excelfilestableobject_0_1;
...
/**
 * Job: ExcelFilesTableObject Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class ExcelFilesTableObject implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "ExcelFilesTableObject.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(ExcelFilesTableObject.class);
	...
	private final String jobName = "ExcelFilesTableObject";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					ExcelFilesTableObject.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ExcelFilesTableObject.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_VALPAK_POC_ExcelFilesTableObject = new byte[0];
		static byte[] commonByteArray_VALPAK_POC_ExcelFilesTableObject = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_VALPAK_POC_ExcelFilesTableObject.length) {
					if (length < 1024 && commonByteArray_VALPAK_POC_ExcelFilesTableObject.length == 0) {
						commonByteArray_VALPAK_POC_ExcelFilesTableObject = new byte[1024];
					} else {
						commonByteArray_VALPAK_POC_ExcelFilesTableObject = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_VALPAK_POC_ExcelFilesTableObject, 0, length);
				strReturn = new String(commonByteArray_VALPAK_POC_ExcelFilesTableObject, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_VALPAK_POC_ExcelFilesTableObject, 0, length);
				strReturn = new String(commonByteArray_VALPAK_POC_ExcelFilesTableObject, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_VALPAK_POC_ExcelFilesTableObject) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileOutputExcel_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputExcel_1.append("FILENAME" + " = "
									+ "\"C:/Users/valpakuser/Desktop/Outputs/JDWilliams Q1 2024 To Load Demo - Table Object_output.xlsx\"");
							log4jParamters_tFileOutputExcel_1.append(" | ");
				...
				String fileName_tFileOutputExcel_1 = "C:/Users/valpakuser/Desktop/Outputs/JDWilliams Q1 2024 To Load Demo - Table Object_output.xlsx";
					...
					class BytesLimit65535_tFileInputExcel_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputExcel_1.append("FILENAME" + " = "
									+ "\"C:/Users/valpakuser/Desktop/ValPak PoC Data/JDWilliams Q1 2024 To Load Demo - Table Object.xlsx\"");
							log4jParamters_tFileInputExcel_1.append(" | ");
							log4jParamters_tFileInputExcel_1.append("PASSWORD" + " = "
									+ String.valueOf(
											"enc:routine.encryption.key.v1:DwexEOayEryUy0/SWe0Ht+wiu++CzL5hkJGB2A==")
											.substring(0, 4)
									+ "...");
							log4jParamters_tFileInputExcel_1.append(" | ");
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:+NQehhSD31PYsm5K1G+cmifJxVLdJE7b1eow5w==");
				String password_tFileInputExcel_1 = decryptedPassword_tFileInputExcel_1;
				if (password_tFileInputExcel_1.isEmpty()) {
					password_tFileInputExcel_1 = null;
				}
				Object source_tFileInputExcel_1 = "C:/Users/valpakuser/Desktop/ValPak PoC Data/JDWilliams Q1 2024 To Load Demo - Table Object.xlsx";
...
// Start of branch "row1"
	...
	public static void main(String[] args) {
		final ExcelFilesTableObject ExcelFilesTableObjectClass = new ExcelFilesTableObject();

		int exitCode = ExcelFilesTableObjectClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'ExcelFilesTableObject' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'ExcelFilesTableObject' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_wMRy0K16Ee-bNPCWZiKZNw");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-12-09T16:48:51.561321400Z");
		...
		try {
			...
			java.io.InputStream inContext = ExcelFilesTableObject.class.getClassLoader()
					.getResourceAsStream("valpak_poc/excelfilestableobject_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ExcelFilesTableObject.class.getClassLoader()
		...
		log.info("TalendJob: 'ExcelFilesTableObject' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : ExcelFilesTableObject");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'ExcelFilesTableObject' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 110712 characters generated by Talend Cloud Data Fabric on the December 9,
 * 2024 at 4:48:51 PM UTC
 ************************************************************************************************/